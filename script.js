document.addEventListener("DOMContentLoaded", () => {
  const fallbackVideos = [
    ...
    '    <video src="FOTOS/VIDEO DOMINADAS.MOV" autoplay loop muted playsinline preload="metadata"></video>',
    "  </div>",
    ...
    '  <div class="video-thumb">',
    '    <video src="FOTOS/VIDEO MUSCLE UP.MOV" autoplay loop muted playsinline preload="metadata"></video>',
    "  </div>",
    '  <div class="video-meta">',
    ...
    '  <div class="video-thumb">',
    '    <video src="FOTOS/VIDEO PINO.mov" autoplay loop muted playsinline preload="metadata"></video>',
    "  </div>",
    '  <div class="video-meta">',
    ...
    '<div class="video-card tall stagger-item">',
    '  <div class="video-thumb">',
    '    <video src="FOTOS/video front LEVER.MOV" autoplay loop muted playsinline preload="metadata"></video>',
    "  </div>",
    '  <div class="video-meta">',
    ...
    '<div class="video-card wide stagger-item">',
    '  <div class="video-thumb">',
    '    <video src="FOTOS/VIDEO FONDOS.mov" autoplay loop muted playsinline preload="metadata"></video>',
    "  </div>",
    '  <div class="video-meta">',
    ...
    '<div class="video-card stagger-item">',
    '  <div class="video-thumb">',
    '    <video src="FOTOS/VIDEO BACK LEVER.MOV" autoplay loop muted playsinline preload="metadata"></video>',
    "  </div>",
    '  <div class="video-meta">',
